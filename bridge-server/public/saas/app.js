      ...
      card.innerHTML = `
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: auto;">
          ...
          <div style="margin-left: 1rem; margin-top: 1rem; text-align: center;">
            <label style="font-size: 0.75rem; color: var(--text-muted); display: block; margin-bottom: 0.25rem;">Game Events</label>
            <label class="switch" style="position: relative; display: inline-block; width: 40px; height: 20px;">
              <input type="checkbox" onchange="toggleEvents('${server.id}', this.checked)" ${server.eventsEnabled ? 'checked' : ''} style="opacity: 0; width: 0; height: 0;">
